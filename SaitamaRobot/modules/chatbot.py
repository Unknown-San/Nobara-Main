...
import html
import requests
import MoeZillaBot.modules.sql.chatbot_sql as sql
...
__help__ = """
Chatbot utilizes the Kuki's api which allows Nobara to talk and provide a more interactive group chat experience.
